...
Module WD_DASK
  ...
  Public Const ErrorInvalidCalBank As Short = -111
	...
	'-----------------------------------------------------------------*/
	Declare Function WD_Register_Card Lib "WD-Dask.dll" (ByVal CardType As Short, ByVal card_num As Short) As Short
	Declare Function WD_Register_Card_By_PXISlot_GA Lib "WD-Dask.dll" (ByVal CardType As Short, ByVal geo_addr As Short) As Short
	Declare Function WD_Release_Card Lib "WD-Dask.dll" (ByVal CardNumber As Short) As Short
	Declare Function WD_Get_SDRAMSize Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByRef sdramsize As Integer) As Short
  Declare Function WD_GetBaseAddr Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByRef BaseAddr As Integer, ByRef BaseAddr2 As Integer) As Short
	Declare Function WD_SoftTriggerGen Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal op As Byte) As Short
  Declare Function WD_GetActualRate Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal fdir As Byte, ByVal ActualRate As Double, ByRef interval As Integer, ByRef ActualRate As Double) As Short
	Declare Function WD_GetPXIGeographAddr Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByRef geo_addr As Byte) As Short
  Declare Function WD_Buffer_Alloc Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal dwSize As UInteger) As IntPtr
	Declare Function WD_Buffer_Free Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal buf As IntPtr) As Integer
  Declare Function WD_Device_Scan Lib "WD-Dask.dll" (<[In](), Out()> ByVal AvailModules() As WD_DEVICE, ByVal ncount As Integer, ByRef retcnt As Integer) As Integer
  Declare Function WD_GetFPGAVersion Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByRef version As UInt32) As Short

	'AI Functions
	Declare Function WD_AI_CH_Config Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal channel As Short, ByVal AdRange As Short) As Short
	Declare Function WD_AI_Config Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal TimeBase As Short, ByVal adDutyRestore As Byte, ByVal ConvSrc As Short, ByVal doubleEdged As Byte, ByVal AutoResetBuf As Byte) As Short
	Declare Function WD_AI_Set_Mode Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal modeCtrl As Short, ByVal wIter As Short) As Short
	Declare Function WD_AI_Trig_Config Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal trigMode As Short, ByVal TrigSrc As Short, ByVal trigPol As Short, ByVal anaTrigChan As Short, ByVal anaTriglevel As Double, ByVal postTrigScans As Integer, ByVal preTrigScans As Integer, ByVal trigDelayTicks As Integer, ByVal reTrgCnt As Integer) As Short
	Declare Function WD_OutTrig_Config Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal trig_Ch As Short, ByVal trig_conf As Short, ByVal trig_width As Short) As Short	
	Declare Function WD_AI_AsyncCheck Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByRef Stopped As Byte, ByRef AccessCnt As Integer) As Short
	Declare Function WD_AI_AsyncClear Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByRef startPos As Integer, ByRef AccessCnt As Integer) As Short
	Declare Function WD_AI_AsyncClearEx Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByRef startPos As Integer, ByRef AccessCnt As Integer, ByVal NoWait As Integer) As Short	
	Declare Function WD_AI_AsyncDblBufferHalfReady Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByRef HalfReady As Byte, ByRef StopFlag As Byte) As Short
	Declare Function WD_AI_AsyncDblBufferMode Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal enable As Byte) As Short
	Declare Function WD_AI_AsyncDblBufferToFile Lib "WD-Dask.dll" (ByVal CardNumber As Short) As Short
	Declare Function WD_AI_ContReadChannel Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal channel As Short, ByVal BufId As Short, ByVal ReadScans As Integer, ByVal ScanIntrv As Integer, ByVal SampIntrv As Integer, ByVal SyncMode As Short) As Short
	Declare Function WD_AI_ContScanChannels Lib "WD-Dask.dll" (ByVal wCardNumber As Short, ByVal wChannel As Short, ByVal BufId As Short, ByVal ReadScans As Integer, ByVal ScanIntrv As Integer, ByVal SampIntrv As Integer, ByVal SyncMode As Short) As Short
	Declare Function WD_AI_ContReadMultiChannels Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal NumChans As Short, ByRef chans As Short, ByVal BufId As Short, ByVal ReadScans As Integer, ByVal ScanIntrv As Integer, ByVal SampIntrv As Integer, ByVal SyncMode As Short) As Short
	Declare Function WD_AI_ContReadChannelToFile Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal channel As Short, ByVal BufId As Short, ByVal FileName As String, ByVal ReadScans As Integer, ByVal ScanIntrv As Integer, ByVal SampIntrv As Integer, ByVal SyncMode As Short) As Short
	Declare Function WD_AI_ContScanChannelsToFile Lib "WD-Dask.dll" (ByVal wCardNumber As Short, ByVal wChannel As Short, ByVal BufId As Short, ByVal FileName As String, ByVal dwReadScans As Integer, ByVal ScanIntrv As Integer, ByVal SampIntrv As Integer, ByVal SyncMode As Short) As Short
	Declare Function WD_AI_ContReadMultiChannelsToFile Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal NumChans As Short, ByRef chans As Short, ByVal BufId As Short, ByVal FileName As String, ByVal ReadScans As Integer, ByVal ScanIntrv As Integer, ByVal SampIntrv As Integer, ByVal SyncMode As Short) As Short
	Declare Function WD_AI_ContStatus Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByRef status As Integer) As Short
	Declare Function WD_AI_InitialMemoryAllocated Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByRef MemSize As Integer) As Short
	Declare Function WD_AI_VoltScale Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal AdRange As Short, ByVal reading As Short, ByRef Voltage As Double) As Short
  Declare Function WD_AI_VoltScale32 Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal AdRange As Short, ByVal reading As Integer, ByRef Voltage As Double) As Short		
	...
	Declare Function WD_AI_ContVScale Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal AdRange As Short, ByRef readingArray As Short, ByRef voltageArray As Double, ByVal count As Integer) As Short
	Declare Function WD_AI_ContVScale Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal AdRange As Short, ByVal readingArray As IntPtr, ByRef voltageArray As Double, ByVal count As Integer) As Short
  Declare Function WD_AI_ContVScale Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal AdRange As Short, ByVal readingArray As IntPtr, ByVal voltageArray As IntPtr, ByVal count As Integer) As Short
  ...
  Declare Function WD_AI_ContBufferSetup Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByRef Buffer As Short, ByVal ReadCount As Integer, ByRef BufferId As UShort) As Short
  Declare Function WD_AI_ContBufferSetup Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal Buffer As IntPtr, ByVal ReadCount As Integer, ByRef BufferId As UShort) As Short
  Declare Function WD_AI_ContBufferSetup32 Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByRef Buffer As Integer, ByVal ReadCount As Integer, ByRef BufferId As UShort) As Short
	...
	Declare Function WD_AI_ContBufferReset Lib "WD-Dask.dll" (ByVal CardNumber As Short) As Short
	Declare Function WD_AI_DMA_Transfer Lib "WD-Dask.dll" (ByVal CardNumber As Short) As Short
	Declare Function WD_AI_ConvertCheck Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByRef StopFlag As Byte) As Short
	Declare Function WD_AI_AsyncReStartNextReady Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByRef DaqReady As Byte, ByRef StopFlag As Byte, ByRef RdyDaqCnt As Byte) As Short        
  Declare Function WD_AI_EventCallBack Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal Mode As Short, ByVal EventType As Short, ByVal callbackAddr As CallbackDelegate) As Short
        
	Declare Function WD_AI_SetTimeout Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal msec As UInteger) As Short
	Declare Function WD_AI_AsyncDblBufferOverrun Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal op As Short, ByRef overrunFlag As Short) As Short
	Declare Function WD_AI_AsyncDblBufferHandled Lib "WD-Dask.dll" (ByVal CardNumber As Short) As Short
	Declare Function WD_AI_AsyncReTrigNextReady Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByRef trgReady As Byte, ByRef StopFlag As Byte, ByRef RdyTrigCnt As Integer) As Short     
	
	'SSI Functions
	Declare Function WD_SSI_SourceConn Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal sigCode As Short) As Short
	Declare Function WD_SSI_SourceDisConn Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal sigCode As Short) As Short
	Declare Function WD_SSI_SourceClear Lib "WD-Dask.dll" (ByVal CardNumber As Short) As Short
  Declare Function WD_Route_Signal Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal signal As Short, ByVal Line As Short, ByVal direct As Short) As Short
	Declare Function WD_Signal_DisConn Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal signal As Short, ByVal Line As Short) As Short
	
	'Calibration Functions
	Declare Function WD_AD_Auto_Calibration_ALL Lib "WD-Dask.dll" (ByVal wCardNumber As Short) As Short
	Declare Function WD_EEPROM_CAL_Constant_Update Lib "WD-Dask.dll" (ByVal wCardNumber As Short, ByVal bank As Short) As Short
	Declare Function WD_Load_CAL_Data Lib "WD-Dask.dll" (ByVal wCardNumber As Short, ByVal bank As Short) As Short
	Declare Function WD_Set_Default_Load_Area Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal bank As Short) As Short
	Declare Function WD_Get_Default_Load_Area Lib "WD-Dask.dll" (ByVal CardNumber As Short) As Short	

	'DI Functions
	Declare Function WD_DI_ReadPort Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal Port As Short, ByRef Value As Integer) As Short
	Declare Function WD_DI_ReadLine Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal Port As Short, ByVal Line As Short, ByRef Value As Short) As Short
	
	'DO Functions
	Declare Function WD_DO_WritePort Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal Port As Short, ByVal Value As Integer) As Short
	Declare Function WD_DO_WriteLine Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal Port As Short, ByVal Line As Short, ByVal Value As Short) As Short
	Declare Function WD_DO_ReadLine Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal Port As Short, ByVal Line As Short, ByRef Value As Short) As Short
	Declare Function WD_DO_ReadPort Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal Port As Short, ByRef Value As Integer) As Short
	
	'DIO Functions
	Declare Function WD_DIO_PortConfig Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal Port As Short, ByVal mode As Short, ByVal Direction As Short) As Short
	Declare Function WD_DIO_LineConfig Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal Port As Short, ByVal wLine As Integer , ByVal Direction As Short) As Short
	Declare Function WD_DIO_LinesConfig Lib "WD-Dask.dll" (ByVal CardNumber As Short, ByVal Port As Short, ByVal mode As Short, ByVal wLinesdirmap As Integer) As Short
